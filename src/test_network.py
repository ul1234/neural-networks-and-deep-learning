...
class TestNetwork(object):
    ...
    def run(self, epoches = 30, mini_batch_size = 10):
        self.net.train(self.training_data, epoches, mini_batch_size, test_data = self.test_data)

    def run_test(self, test, init_weight_func = WeightOpt(), epoches = 10):
        ...
        for func_args in test:
            ...
            self.run(epoches = epoches)

    def test_CrossEntropy_vs_Quadratic(self, epoches = 10, learning_rate = 3.0):
        self.run_test([(self.test_scenario.sigmoid_sigmoid_quadratic, learning_rate),
                       ...
                       init_weight_func = WeightRandom(0.5), epoches = epoches)

    def test_softmax(self, epoches = 10, learning_rate = 3.0):
        self.run_test([(self.test_scenario.sigmoid_softmax_loglikelihood, learning_rate),
                       (self.test_scenario.sigmoid_sigmoid_crossentropy, learning_rate)],
                       init_weight_func = WeightRandom(0.5), epoches = epoches)

    def test_ReLU(self, epoches = 10, learning_rate = 0.1):
    ...
    def test_tanh(self, epoches = 10, learning_rate = 0.1):
        self.run_test([(self.test_scenario.tanh_softmax_loglikelihood, learning_rate),
                       (self.test_scenario.sigmoid_sigmoid_quadratic, learning_rate)],
                       epoches = epoches)

    def test(self, epoches = 10, learning_rate = 3.0):
        self.run_test([(self.test_scenario.sigmoid_sigmoid_quadratic, learning_rate),
                       (self.test_scenario.sigmoid_sigmoid_crossentropy, learning_rate),
                       (self.test_scenario.sigmoid_softmax_loglikelihood, learning_rate)],
                       epoches = epoches)
                       
    def test_best(self, epoches = 10, learning_rate = 0.1, regular_lmda = 0.01):
        self.run_test([#(self.test_scenario.ReLU_softmax_loglikelihood, learning_rate),
    ...
    def test_momentum(self, epoches = 10, learning_rate = 3.0):
        self.run_test([(self.test_scenario.sigmoid_sigmoid_quadratic_momentum, learning_rate),
                       (self.test_scenario.sigmoid_sigmoid_quadratic, learning_rate)],
                       epoches = epoches)

    def test_regularization(self, epoches = 10, learning_rate = 0.1):
    ...
    def test_dropout(self, epoches = 10, learning_rate = 0.1):
...
if __name__ == '__main__':
    ...
    #test.test_best(60, learning_rate = 0.01, regular_lmda = 0.5)
    test.test_dropout(400, 0.5)
